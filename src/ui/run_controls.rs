use eframe::egui::{self, Color32, RichText, Button};
...
impl RunControls {
    ...
    pub fn show(&mut self, ui: &mut egui::Ui, data: &mut DynoData) {
        ui.horizontal(|ui| {
            // Start/Stop button
            let start_stop_text = if self.is_running { "Stop Test" } else { "Start Test" };
            ...
            if ui.add(Button::new(RichText::new(start_stop_text)
                .size(14.0)
                .color(Color32::WHITE))
            ...
            if ui.add(Button::new(RichText::new("EMERGENCY STOP")
                .size(14.0)
                .color(Color32::WHITE))
            ...
            // Reset button
            if ui.add(Button::new(RichText::new("Reset")
                .size(14.0)
                .color(Color32::WHITE))
